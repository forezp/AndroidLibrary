...
@EActivity(R.layout.activity_greendao)
public class GreenDActivity extends ListActivity {
    ...
    private void addNote() {
        ...
        if (noteText == null || noteText.equals("")) {
           // ToastUtils.show(getApplicationContext(), "Please enter a note to add");
            Toast.makeText(GreenDActivity.this,  "Please enter a note to add",Toast.LENGTH_SHORT);
        } else {
    ...
    private void search() {
        ...
        if (noteText == null || noteText.equals("")) {
           ...
           // ToastUtils.show(getApplicationContext(), "There have " + notes.size() + " records");
            Toast.makeText(GreenDActivity.this, "There have " + notes.size() + " records",Toast.LENGTH_SHORT);
        }
...
//        getNoteDao().deleteAll();
        Toast.makeText(GreenDActivity.this, "Deleted note, ID: " + id,Toast.LENGTH_SHORT);
